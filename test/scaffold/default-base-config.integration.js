...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    var atbcoind = info.config.servicesConfig.atbcoind;
      atbcoind.spawn.datadir.should.equal(home + '/.atbcoin');
      atbcoind.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/atbcoind'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.atbcoind.spawn.datadir.should.equal('./data2');
  });
});
